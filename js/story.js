...
define(['common', 'swiper', 'jquery'], function (core, Swiper, $) {
    ...
    var modal = {
        ...
        commentList: [],
        colorList: [{c: "#E17166", b: "#FDD9D5"}, {c: "#F3BA5B", b: "#FDF4E7"}, {c: "#5394F1", b: "#EDF4FB"}]
    };
    ...
    modal.dataInit = function () {
        core.request({
            url: modal.server[modal.env] + "/xiangdao-api/api/news/tale_details/" + modal.id,
            method: "GET",
            success: function (res) {
                console.log(res);
                if (res.status === 0) {
